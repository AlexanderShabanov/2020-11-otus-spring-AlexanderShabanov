...
class CommentRepositoryJpaImplTest {
    ...
    void shouldSaveNew() {
        var id = commentRepository.save(new Comment(null, new User("3", "Вася", "pswd", USER_ROLE), "коммент", new Book("5", new Author("6", "автор", "авторович"), List.of(new Genre("5", "жанр")), "книга")));
        assertNotNull(id);
    }
