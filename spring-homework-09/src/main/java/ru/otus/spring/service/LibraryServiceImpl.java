...
public class LibraryServiceImpl implements LibraryService {
    ...
    @Override
    @Transactional
    public void insertBook(BookDto book, boolean createRelatedObjects) {
        saveBook(book, createRelatedObjects);
    }

    @Override
    @Transactional
    public void updateBook(BookDto bookDto, boolean createRelatedObjects) {
        saveBook(bookDto, createRelatedObjects);
    }

    private void saveBook(BookDto bookDto, boolean createRelatedObjects) {
